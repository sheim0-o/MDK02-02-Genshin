	...
	<body>
	    <form id = "form_nov">
			...
			<div id = paragraph>
				...
				<input type="text" id = 1 name="NUMBERUPDATE" placeholder="Îáÿçàòåëüíîå ïîëå" pattern="^[0-9]{1,2}[.][0-9]{1,3}$">
				<p></p>
				...
				<p><input type="submit" value="Îòïðàâèòü" class="btn btn-default" id="btn" onclick="empty()"></p>
			</div>
		</form>
